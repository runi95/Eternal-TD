...
export class Trigger {
    ...
    public registerPlayerUnitEvent(whichPlayer: player, whichPlayerEvent: playerunitevent): event {
        return TriggerRegisterPlayerUnitEventSimple(this.nativeTrigger, whichPlayer, whichPlayerEvent);
    }
}
